            ...
            try {
                ...
                if (role.position >= botMember.roles.highest.position) {
                    const embed = new EmbedBuilder()
                        ...
                        .setImage(process.env.RedLine)
                        .setDescription('I cannot assign this role as it is higher than or equal to my highest role.');
                    return interaction.editReply({ embeds: [embed] });
                }
                ...
                if (targetMember.roles.cache.has(role.id)) {
                    const embed = new EmbedBuilder()
                        ...
                        .setDescription(`User ${targetUser} already has the role <@&${role.id}>.`);
                    return interaction.editReply({ embeds: [embed] });
                }
                ...
                const successEmbed = new EmbedBuilder()
                    ...
                    .setDescription(`Successfully gave the role <@&${role.id}> to ${targetUser}.`)
                    .addFields(
