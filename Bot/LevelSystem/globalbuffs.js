...
const buffSystem = {
    // ========== ⭐ هنا حط الـ IDs ==========
    roleBuffs: new Map([
        ["1465705033604792558", 1],  // ضع الـ ID الحقيقي
        ["1465705074343809096", 1],
        ["1465705124176597075", 1],// ضع ID آخر
        ["1466171805869019137", 1],// ضع ID آخر
        ["1394820196375593122", 1],// ضع ID آخر
        ["1441450267965915296", 1],// ضع ID آخر
        ["1465800603224510536", 1],// ضع ID آخر
    ]),
    // ========== ⭐ ==========
